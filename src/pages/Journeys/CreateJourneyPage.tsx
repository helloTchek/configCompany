                ...
                placeholder='[
  {
    ...
    "config": {
      "localization": [
        {
          "locale": "fr",
          "text": "Used only in webhook (FR)"
        },
        {
          "locale": "en",
          "text": "Used only in webhook (EN)"
        }
      ],
              ...
              },
              {
                ...
                "data": {
                  "localization": [
                    {
                      "locale": "fr",
                      "text": "Merci de répondre aux quelques questions suivantes."
                    },
                    {
                      "locale": "en",
              ...
              },
              {
                ...
                "data": {
                  "localization": [
                    {
                      "locale": "fr",
                      "text": "Marquez la date d'aujourd'hui"
                    },
                    {
                      "locale": "en",
          ...
          "body": {
            "blockListing": [
              ...
              },
              {
                ...
                "data": {
                  ...
                  "localization": [
                    {
                      "locale": "fr",
                      "text": "Quel est le VIN de votre véhicle?",
                      "placeholder": "Ex: VX1234...XYZ"
                    },
                    {
                      "locale": "en",
                      "text": "What is the VIN of your vehicle?",
                      "placeholder": "Ex: VX1234...XYZ"
                    }
                  ]
                }
              },
              {
                ...
                "order": 5,
                "form": true,
                "businessType": "save#Vehicle@mileage",
                "optional": false,
                "optionnal": false,
                "data": {
                  "minValue": 1,
                  ...
                  "localization": [
                    {
                      "locale": "fr",
                      "text": "Combien de kilomètres au compteur ?",
                      "placeholder": "Ex: 3000km",
                      "suffix": "km"
                    },
                    {
                      "locale": "en",
              ...
              },
              {
                ...
                "order": 6,
                "form": true,
                "businessType": "save#Vehicle@firstRegistrationDate",
                "optional": false,
                "optionnal": false,
                "data": {
                  "localization": [
                    {
                      "locale": "fr",
                      "text": "Quelle est la date de 1ère immatriculation de votre véhicule ?"
                    },
                    {
                      "locale": "en",
                      "text": "When was your vehicle first registered?"
                    }
                  ],
                  "options": null
                }
        ...
        },
        {
          ...
          "body": {
            "blockListing": [
              ...
              {
                "id": "dropdown-screen2-1",
                "type": "dropdown",
                "order": 23,
                "form": true,
                "businessType": "repairCosts",
                "keyCost": "XXX@QU2",
                "optional": true,
                "optionnal": true,
                "data": {
                  "localization": [
                    {
                      "locale": "fr",
                      "text": "Quel est le carburant de votre véhicule ?",
                      "placeholder": "Merci de sélectionner dans la liste déroulante..."
                    },
                    {
                      "locale": "en",
                      "text": "What kind of fuel does your car use?",
                      "placeholder": "Please select from the drop-down list..."
                    }
                  ],
                  "options": [
                    {
                      "localization": [
                        {
                          "locale": "fr",
                          "text": "Sans-Plomb 95 - E10"
                        },
                        {
                          "locale": "en",
                          "text": "Unleaded 95 - E10"
                        }
                      ],
                      "order": 1,
                      "value": "unleaded_95-E10",
                      "keyCost": "XXX@QU2@ANS1"
                    },
                    {
                      "localization": [
                        {
                    ...
                    },
                    {
                      ...
                      "order": 3,
                      "value": "diesel",
                      "keyCost": "XXX@QU2@ANS3"
                    }
                  ]
                }
              },
              {
                "id": "checkbox-screen2-QU4",
                "type": "checkbox",
                "order": 26,
                "form": true,
                "businessType": "repairCosts",
                ...
                "optionnal": true,
                "data": {
                  "hideQuestionInFrontEnd": false,
                  "localization": [
                    {
                      "locale": "fr",
                      "text": "Si des accessoires sont manquants dans le véhicule merci de nous en faire part en cochant le ou les accessoire(s) manquant(s) ci-dessous :"
                    },
                    {
                      "locale": "en",
                      "text": "If any of the following accessories are missing from the vehicle, please tick the corresponding box:"
                    }
                  ],
                  "options": [
                    {
                      ...
                      "order": 1,
                      "value": true,
                      "keyCost": "XXX@QU4@ANS1"
                    }
                  ]
                }
              },
              {
                "id": "checkbox-screen2-QU5",
                "type": "checkbox",
                "order": 27,
                "form": true,
                "businessType": "repairCosts",
                  ...
                  "options": [
                    {
                      ...
                      "order": 1,
                      "value": true,
                      "keyCost": "XXX@QU5@ANS1"
                    }
                  ]
                }
              },
              {
                "id": "checkbox-screen2-QU6",
                "type": "checkbox",
                "order": 28,
                "form": true,
                "businessType": "repairCosts",
          ...
          "body": {
            "blockListing": [
              ...
              },
              {
                ...
                "data": {
                  "localization": [
                    {
                      "locale": "fr",
                      "text": "Le pare-brise présente-t-il des éclats ou des fissures ?"
                    },
                    {
                      "locale": "en",
                      "text": "Is there any unrepaired stone chip or crack on the windshield?"
                    }
                  ],
                  "options": [
                    {
                    ...
                    },
                    {
                      "localization": [
                        {
                          "locale": "fr",
                          "text": "Oui, de moins de 3 centimètres de diamètre et localisé dans la zone 'bleue'"
                        },
                        {
                          "locale": "en",
                          "text": "Yes, less than 3 centimeters in diameter and in the 'blue' area"
                        }
                      ],
                      "keyCost": "XXX@QU21@ANS2",
                      "value": "yes_A"
                    },
                    {
                      "localization": [
                        {
                          "locale": "fr",
                          "text": "Oui, de plus de 3 centimètres de diamètre et localisé dans la zone 'bleue'"
                        },
                        {
                          "locale": "en",
                          "text": "Yes, more than 3 centimeters in diameter and in the 'blue' area"
                        }
                      ],
                      "keyCost": "XXX@QU21@ANS3",
                      "value": "yes_B"
                    },
                    {
                      "localization": [
                        {
                          "locale": "fr",
                          "text": "Oui, localisé dans la zone rouge"
                        },
                        {
                          "locale": "en",
                          "text": "Yes, the chip/crack is located in the 'red' area"
                        }
                      ],
                      "keyCost": "XXX@QU21@ANS4",
                      "value": "yes_C"
                    }
                  ]
                }
              },
              {
                ...
                "data": {
                  "file": {
                    "url": "https://tchek-images.s3.eu-west-3.amazonaws.com/webapp/forms/windshield-Lynk%26Co.png"
                  },
                  "minWidth": null,
                  "maxWidth": null,
                  "keepRatio": true,
                  ...
                  "localization": [
                    {
                      "locale": "fr",
                      "text": "Commentaires",
                      "placeholder": "Un détail dont vous aimeriez nous parler ? ..."
                    },
                    {
                      "locale": "en",
                      "text": "Comments",
