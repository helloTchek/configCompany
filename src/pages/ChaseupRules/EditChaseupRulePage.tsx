...
export default function EditChaseupRulePage() {
  ...
  useEffect(() => {
    ...
    if (rule) {
      setFormData({
        ...
        secondDelayMinutes: rule.secondDelayMinutes,
        maxSendings: rule.maxSendings,
        firstReminder: rule.firstReminder,
  ...
  const handleSave = () => {
    ...
    const updatedRule: ChaseupRule = {
      id: id!,
      ...formData,
      createdAt: mockChaseupRules.find(r => r.id === id)?.createdAt || new Date().toISOString(),
      updatedAt: new Date().toISOString()
    };

    console.log('Updating chase-up rule:', updatedRule);
    navigate('/chaseup-rules');
  };
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600">Loading chase-up rule...</p>
          </div>
        </div>
      </div>
    );
